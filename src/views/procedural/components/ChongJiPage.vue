<template>
  <div>
    <div>[3/5]冲击分析-{{ condition.train_mode }}-{{ condition.train_number }}</div>
    <el-divider />
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="冲击样本分析" name="first">
        <CJSample />
      </el-tab-pane>
      <el-tab-pane label="冲击趋势分析" name="second">
        <CJTrend />
      </el-tab-pane>
      <el-tab-pane label="SV值均值分析" name="third">
        <CJSValue />
      </el-tab-pane>
      <el-tab-pane label="报警信息" name="fourth">
        <CJAlarm />
      </el-tab-pane>
    </el-tabs>
    <el-divider />
